...
def create_new_emg_admission(patient_id: str):
  """Create new admission into emergency ward"""
  try:
    ...
    if not lookup_result:
      return {"error": True, "reason": "patient not found"}
    ...
    # insert_ok = client[emg_dept_collection].insert_one(payload).acknowledged
    # if not insert_ok:
